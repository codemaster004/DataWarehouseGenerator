...
def simulation_episode(df_users, df_agents, df_estates, df_requests, entities_conf):
...
def main():
	...
	for i in range(N_EPISODES):
		simulation_episode(df_users, df_agents, df_estates, df_requests, entities_conf)
